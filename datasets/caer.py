...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (args.data_path+"train/", args.data_path+'train.json'),
        "val": (args.data_path+"test/", args.data_path+'test.json'),
    }
...
if __name__ == "__main__":
    ...
    dataset_train = FaceDetection('/data1/xinpeng/CAER_S/train', '/data1/xinpeng/CAER_S/train.json', transforms=make_face_transforms('train'), return_masks=False)
    sampler_train = torch.utils.data.SequentialSampler(dataset_train)
    batch_sampler_train = torch.utils.data.BatchSampler(sampler_train, 100, drop_last=True)
