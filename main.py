...
def get_args_parser():
    ...
    parser.add_argument('--lr_drop', default=40, type=int) # 0.8 * epochs
    ...
    parser.add_argument('--pretrained_weights', type=str, default='./r50_deformable_detr-checkpoint.pth', 
    ...
    parser.add_argument('--data_path', default='/home/xinpeng/CAER_S/', type=str)
...
def main(args):
    ...
    n_parameters = sum(p.numel() for p in model.parameters() if p.requires_grad) // 1000000
